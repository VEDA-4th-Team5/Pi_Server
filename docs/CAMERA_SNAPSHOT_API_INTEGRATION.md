...
# CV API는 0-based channel을 사용한다. CH1(EV01~04)과 CH3(EV05~08, EVDA-238)는
# 서로 다른 Snapshot API channel을 쓰므로 슬롯마다 명시해야 한다.
...
export IVA_EV05_SNAPSHOT_API_CHANNEL=2
export IVA_EV06_SNAPSHOT_API_CHANNEL=2
export IVA_EV07_SNAPSHOT_API_CHANNEL=2
export IVA_EV08_SNAPSHOT_API_CHANNEL=2
```
